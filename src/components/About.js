      ...
      <div class="bg-black">
        ...
        <div class="flex flex-col md:flex-row">
          <div class="md:w-1/2">
            ...
            <div class=" bg-amber-500 text-center mx-24 rounded-full py-2">
            ...
            <div class=" bg-amber-500 text-center mx-24 rounded-full py-2 mt-2">
          ...
          <div class="md:w-1/2 ">
            ...
            <div class="">
              <div class="bg-amber-500 text-center mx-24 rounded-full py-2 mt-6">
